...
output$Chooser=renderUI({
  ...
  tagList(
      ...
      fluidRow(
        ...
        column(3,
               textInput3("newname","New column name",placeholder = "mean or sum",width=150),
               hr(),
               ...
               actionButton("recodeRank","Recode rank",icon=icon("sort-numeric-desc"),width="150px"),
      ...
      textInput3("calText","Enter Equation",placeholder = "Example: LDL = TC - TG/5 -HDL",width=350),
      actionButton("calculateCol","Calculate",icon=icon("calculator"),width="150px")
    ))
})
